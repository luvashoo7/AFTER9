...
import { ShoppingBag, Moon, Clock, MapPin, Menu, X, ShieldCheck, Zap, Sparkles } from 'lucide-react';
    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="hidden md:flex items-center justify-between max-w-7xl mx-auto px-6 mb-2 text-xs font-mono">
        <div className="flex items-center gap-3 text-slate-400">
          ...
          <span className="flex items-center gap-1 text-slate-300">
            ...
            PILOT ZONE: <strong className="text-white">GREATER NOIDA</strong>
          </span>
        </div>
        <div className="flex items-center gap-4 text-slate-400">
          ...
          <span className="text-emerald-400 flex items-center gap-1">
            <ShieldCheck className="w-3.5 h-3.5" /> Open-Box Doorstep Verification Active
          </span>
        </div>
      </div>
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-1 bg-[#0f0f1c]/80 border border-white/[0.08] px-3 py-1.5 rounded-full backdrop-blur-md">
          <a href="#drops" className="px-3.5 py-1.5 rounded-full text-xs font-semibold text-slate-300 hover:text-[#bef264] hover:bg-white/[0.04] transition-all">
            🔥 Tonight's Drops
          </a>
          <a href="#categories" className="px-3.5 py-1.5 rounded-full text-xs font-semibold text-slate-300 hover:text-[#bef264] hover:bg-white/[0.04] transition-all">
            🌙 2 AM Cravings
          </a>
          <a href="#ten-rupee" className="px-3.5 py-1.5 rounded-full text-xs font-semibold text-[#a3e635] hover:bg-[#a3e635]/10 transition-all flex items-center gap-1">
            <Sparkles className="w-3 h-3" /> ₹10 Corner
          </a>
          <a href="#party-packs" className="px-3.5 py-1.5 rounded-full text-xs font-semibold text-slate-300 hover:text-[#bef264] hover:bg-white/[0.04] transition-all">
            🎉 Midnight Bundles
          </a>
          <a href="#open-box-usp" className="px-3.5 py-1.5 rounded-full text-xs font-semibold text-purple-300 hover:text-white hover:bg-[#a78bfa]/20 transition-all flex items-center gap-1">
            <ShieldCheck className="w-3 h-3 text-[#a78bfa]" /> Open-Box Check
          </a>
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#080810]/95 backdrop-blur-2xl border-b border-white/10 px-6 py-6 space-y-4 animate-in slide-in-from-top duration-200">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm font-semibold">
            ...
            <a
              href="#open-box-usp"
              onClick={() => setMobileMenuOpen(false)}
              className="p-3 bg-[#10101c] rounded-xl text-purple-300 flex items-center gap-2 col-span-2"
            >
              <ShieldCheck className="w-4 h-4 text-[#a78bfa]" /> Open-Box Delivery System
            </a>
            <a
              href="#coverage"
              onClick={() => setMobileMenuOpen(false)}
              className="p-3 bg-[#10101c] rounded-xl text-slate-200 flex items-center gap-2 col-span-2"
            >
              📍 Greater Noida Coverage Map
            </a>
          </div>
